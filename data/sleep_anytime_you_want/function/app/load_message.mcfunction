#> sleep_anytime_you_want:app/load_message
# Called on load

execute if score &sleep_anytime_you_want_load_message jodek.config matches 1 run tellraw @a [\
  {\
    "text": "[",\
    "color": "#aaaaaa"\
  },\
  {\
    ...
    "hover_event": {\
      ...
      "value": [\
        {\
          "nbt":"tellraw[]",\
          "storage": "sleep_anytime_you_want:image",\
          interpret: true,\
          separator: ""\
        }\
      ]\
